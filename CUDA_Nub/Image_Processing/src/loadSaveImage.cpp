...
void loadImageGrey(const std::string &filename,
    ...
    *imagePtr = new unsigned char[image.rows * image.cols]; // Improve memory management/ownership
...
void loadImageRGBA(const std::string &filename,
    ...
    *imagePtr = new uchar4[image.rows * image.cols]; // Improve memory management/ownership
